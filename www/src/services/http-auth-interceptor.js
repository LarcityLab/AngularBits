      ...
      return {
        responseError: function(rejection) {
            ...
            if (rejection.status === 401) {
              ...
              // customized - nullify user object authorization
              delete($rootScope.User['Authorization']);
              $rootScope.User = null;
              $.jStorage.set(USER_KEY, null);
              /** @TODO get refresh token instead **/
              window.location.href = $rootScope.Links.LoginLink;
